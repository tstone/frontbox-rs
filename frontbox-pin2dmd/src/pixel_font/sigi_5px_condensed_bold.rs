...
/// Sigi Condensed Bold 5px pixel font by Rasmus Andersson
/// CC0 Public Domain License
/// https://github.com/rsms/sigi-pixel-font/tree/master
pub static SIGI_CONDENSED_BOLD_5PX_FONT: LazyLock<PixelFontCharacterMap> = LazyLock::new(|| {
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        true, true, true, true, false, true, true, false, true, true, true, true, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        false, true, true, true, false, true, true, false, true, true, true, true, false, false,
        false, true, true, false, true, true, false, true, true, true, false,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 4,
      pixels: vec![
        true, true, true, true, false, true, true, false, false, true, true, false, false, true,
        true, false, true, true, true, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        ...
        true, true, false, false, true, true, false, true, true, false, true, true, false, false,
        true, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        true, true, false, true, true, true, true, false, true, true, false, false, true, false,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 4,
      pixels: vec![
        true, true, true, false, false, false, true, true, false, true, true, false, false, false,
