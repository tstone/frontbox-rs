...
/// Sigi Bold 7px pixel font by Rasmus Andersson
/// CC0 Public Domain License
/// https://github.com/rsms/sigi-pixel-font/tree/master
pub static SIGI_BOLD_7PX_FONT: LazyLock<PixelFontCharacterMap> = LazyLock::new(|| {
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 7,
      pixels: vec![
        false, true, true, true, true, true, false, true, true, false, false, false, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 6,
      pixels: vec![
        false, true, true, true, true, false, true, true, false, false, true, true, false, false,
        false, false, true, true, false, false, false, true, true, false, false, false, true, true,
        false, false, false, true, true, false, false, false, true, true, true, true, true, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 7,
      pixels: vec![
        false, false, false, true, true, true, false, false, false, true, true, true, true, false,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        false, true, true, true, true, true, false, true, true, false, false, false, true, true,
        true, true, false, false, false, false, false, true, true, true, true, true, true, false,
        true, true, false, false, false, true, true, true, true, false, false, false, true, true,
        false, true, true, true, true, true, false,
      ],
    },
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        ...
        true, true, false, false, false, true, true, false, false, false, false, true, true, false,
        false,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        false, true, true, true, true, true, false, true, true, false, false, false, true, true,
        true, true, false, false, false, true, true, false, true, true, true, true, true, false,
        true, true, false, false, false, true, true, true, true, false, false, false, true, true,
        false, true, true, true, true, true, false,
      ],
    },
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 7,
      pixels: vec![
        true, true, true, true, true, true, false, true, true, false, false, false, true, true,
        true, true, false, false, false, true, true, true, true, true, true, true, true, false,
        true, true, false, false, false, true, true, true, true, false, false, false, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        false, true, true, true, true, true, false, true, true, false, false, false, true, true,
        true, true, false, false, false, false, false, true, true, false, false, true, true, true,
        true, true, false, false, false, true, true, true, true, false, false, false, true, true,
        false, true, true, true, true, true, false,
      ],
    },
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        ...
        true, true, false, false, false, false, false, true, true, true, true, false, false, false,
        true, true, false, true, true, true, true, true, false,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 7,
      pixels: vec![
        true, true, false, false, false, true, true, true, true, false, false, true, true, false,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        ...
        false, false, false, true, true, false, false, false, false, true, true, true, true, true,
        true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        ...
        true, true, false, true, false, true, true, true, true, false, false, false, true, true,
        true, true, false, false, false, true, true, true, true, false, false, false, true, true,
        true, true, false, false, false, true, true,
      ],
    },
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        false, true, true, true, true, true, false, true, true, false, false, false, true, true,
        true, true, false, false, false, true, true, true, true, false, false, false, true, true,
        true, true, false, false, false, true, true, true, true, false, false, true, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        ...
        false, false, true, true, false, true, true, true, false, false, true, true, true, false,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        true, true, false, false, false, true, true, true, true, false, false, false, true, true,
        false, true, true, false, true, true, false, false, false, true, true, true, false, false,
        false, true, true, false, true, true, false, true, true, false, false, false, true, true,
        true, true, false, false, false, true, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        ...
        true, false, false, false, true, true, true, true, false, false, false, false, false, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        ...
        false, false, true, true, false, false, false, false, true, true, true, true, true, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        false, true, true, false, true, true, false, false, false, false, false, false, false,
        false, false, true, true, true, true, true, false, true, true, false, false, false, true,
        true, true, true, false, false, false, true, true, true, true, false, false, false, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        ...
        false, false, false, false, false, true, true, false, true, true, false, false, true, true,
        true, false, false, true, true, true, true, false, true, true, false, true, true, false,
        true, true, true, true, false, false, true, true, true, false, true, true, false, false,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 11,
      pixels: vec![
        false, true, true, true, false, false, true, true, false, false, false, true, true, false,
        true, true, false, true, true, false, false, false, false, true, true, true, false, true,
        ...
        false, false, false, false, false, true, true, true, true, false, true, true, false, false,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 6,
      pixels: vec![
        false, false, true, true, false, false, false, true, true, true, true, false, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        ...
        true, false, false, false, true, true, false, true, true, false, true, true, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        ...
        true, false, false, true, true, true, false, false, false, true, false, true, false, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 3,
      pixels: vec![
        false, true, true, true, true, false, true, true, false, true, true, false, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 3,
      pixels: vec![
        true, true, true, true, true, false, true, true, false, true, true, false, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 3,
      pixels: vec![
        true, true, true, false, true, true, false, true, true, false, true, true, false, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 4,
      pixels: vec![
        false, false, true, true, false, true, true, false, false, true, true, false, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 4,
      pixels: vec![
        true, true, false, false, true, true, false, false, true, true, false, false, false, true,
        true, false, false, true, true, false, false, false, true, true, false, false, true, true,
      ],
    },
  );
