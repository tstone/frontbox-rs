...
/// Sigi Regular 5px pixel font by Rasmus Andersson
/// CC0 Public Domain License
/// https://github.com/rsms/sigi-pixel-font/tree/master
pub static SIGI_REGULAR_5PX_FONT: LazyLock<PixelFontCharacterMap> = LazyLock::new(|| {
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        false, true, true, true, false, true, false, false, false, true, false, false, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        true, true, true, true, true, false, false, false, true, false, false, true, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        false, false, true, true, false, false, true, false, true, false, true, true, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        false, true, true, true, false, true, false, false, false, true, true, true, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        true, true, true, true, true, false, false, false, true, false, false, false, true, false,
        false, false, true, false, false, false, true, true, true, true, true,
      ],
    },
  );
