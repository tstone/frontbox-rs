...
/// Derived from SIGI 5px Regular, downsampled to 4px
pub static SIGISH_REGULAR_4PX_FONT: LazyLock<PixelFontCharacterMap> = LazyLock::new(|| {
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        false, true, true, true, false, true, false, false, false, true, false, true, false, false,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        true, true, true, true, true, false, false, false, false, true, false, false, true, false,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        false, true, true, true, false, false, true, true, true, false, true, false, false, false,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        true, true, true, true, false, true, false, false, false, true, true, true, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        true, false, false, false, true, true, false, false, true, false, true, true, false, true,
        false, true, false, false, false, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        true, false, false, false, true, true, true, false, true, true, true, false, false, false,
        true, true, false, false, false, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        true, false, false, false, true, true, false, false, false, true, true, false, true, false,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        true, false, false, false, true, false, true, false, true, false, false, true, false, true,
        false, true, false, false, false, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        true, true, true, true, true, false, false, false, true, false, false, true, false, false,
        false, true, true, true, true, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        false, true, false, true, false, false, true, true, true, false, true, true, true, true,
        true, true, false, false, false, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      name: "!",
      width: 1,
      pixels: vec![true, true, false, true],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        false, true, false, true, false, true, true, true, true, true, true, true, true, true,
        true, false, true, false, true, false,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        false, true, true, true, false, true, false, true, false, false, false, false, true, false,
        true, false, true, true, true, false,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        true, true, false, false, true, true, true, false, true, false, false, true, false, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      name: "*",
      width: 2,
      pixels: vec![true, true, true, true, false, false, false, false],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      name: "(",
      width: 2,
      pixels: vec![false, true, true, false, true, false, false, true],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      name: ")",
      width: 2,
      pixels: vec![true, false, false, true, false, true, true, false],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      name: "[",
      width: 2,
      pixels: vec![true, true, true, false, true, false, true, true],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      name: "]",
      width: 2,
      pixels: vec![true, true, false, true, false, true, true, true],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      name: ".",
      width: 1,
      pixels: vec![false, false, false, true],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      name: ",",
      width: 2,
      pixels: vec![false, false, false, false, false, true, true, false],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      name: ";",
      width: 2,
      pixels: vec![false, false, false, true, false, true, true, false],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      name: "`",
      width: 2,
      pixels: vec![true, false, false, true, false, false, false, false],
    },
  );

  PixelFontCharacterMap {
    name: "Sigi 4px Regular",
    height: 4,
    glyphs,
  }
});
