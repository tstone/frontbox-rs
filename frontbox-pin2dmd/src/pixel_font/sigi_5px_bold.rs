...
pub static SIGI_BOLD_5PX_FONT: LazyLock<PixelFontCharacterMap> = LazyLock::new(|| {
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        false, true, true, true, false, true, true, false, true, true, false, false, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        false, false, true, true, false, false, true, true, true, false, true, true, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 4,
      pixels: vec![
        true, true, true, true, true, true, false, false, true, true, true, true, false, false,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        false, true, true, true, false, true, true, false, false, false, true, true, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 4,
      pixels: vec![
        true, true, true, true, false, false, true, true, false, false, true, true, false, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 5,
      pixels: vec![
        false, true, true, true, false, true, true, false, true, true, false, true, true, true,
        false, true, true, false, true, true, false, true, true, true, false,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        true, true, true, true, true, true, true, true, false, false, false, false, true, true,
        true, true, true, false, true, true, false, false, false, false, true, true, false, false,
        false, false,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 6,
      pixels: vec![
        false, true, true, true, true, true, true, true, false, false, false, false, true, true,
        false, true, true, true, true, true, false, false, true, true, false, true, true, true,
        true, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 6,
      pixels: vec![
        true, true, false, false, true, true, true, true, false, false, true, true, true, true,
        true, true, true, true, true, true, false, false, true, true, true, true, false, false,
        true, true,
      ],
    },
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        false, true, true, true, true, false, true, true, false, false, true, true, true, true,
        false, false, true, true, true, true, false, true, true, false, false, true, true, true,
        true, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        true, true, true, true, true, false, true, true, false, false, true, true, true, true,
        true, true, true, false, true, true, false, true, true, false, true, true, false, false,
        true, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 6,
      pixels: vec![
        false, true, true, true, true, false, true, true, false, false, false, false, false, true,
        true, true, true, false, false, false, false, false, true, true, false, true, true, true,
        true, false,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        ...
        false, true, true, false, true, true, false, false, true, true, true, true, true, false,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        true, true, false, false, false, true, true, true, true, false, false, false, true, true,
        true, true, false, true, false, true, true, true, true, false, true, false, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        ...
        true, true, false, false, false, true, true, true, true, false, true, true, false, false,
        true, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 6,
      pixels: vec![
        true, true, true, true, true, true, false, false, false, true, true, false, false, false,
        true, true, false, false, false, true, true, false, false, false, true, true, true, true,
        true, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      name: "!",
      width: 2,
      pixels: vec![true, true, true, true, true, true, false, false, true, true],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 7,
      pixels: vec![
        false, true, true, false, true, true, false, true, true, true, true, true, true, true,
        false, true, true, false, true, true, false, true, true, true, true, true, true, true,
        false, true, true, false, true, true, false,
      ],
    },
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 6,
      pixels: vec![
        false, true, true, true, true, false, true, true, true, true, false, false, false, true,
        true, true, true, false, false, false, true, true, true, true, false, true, true, true,
        true, false,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 6,
      pixels: vec![
        true, true, false, false, true, true, true, true, false, true, true, false, false, false,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 4,
      pixels: vec![
        false, true, true, false, true, true, true, true, false, false, false, false, false, false,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      pixels: vec![
        ...
        true, true, false, false, true, true, false, true, true, false, false, true, true, true,
        true, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 3,
      pixels: vec![
        true, true, false, false, true, true, false, true, true, false, true, true, true, true,
        false,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 3,
      pixels: vec![
        true, true, true, true, true, false, true, true, false, true, true, false, true, true, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 3,
      pixels: vec![
        true, true, true, false, true, true, false, true, true, false, true, true, true, true, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 4,
      pixels: vec![
        false, true, true, true, false, true, true, false, true, true, false, false, false, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 4,
      pixels: vec![
        true, true, true, false, false, true, true, false, false, false, true, true, false, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 4,
      pixels: vec![
        false, false, true, true, false, false, true, true, false, true, true, false, true, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 4,
      pixels: vec![
        true, true, false, false, true, true, false, false, false, true, true, false, false, false,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      name: "|",
      width: 2,
      pixels: vec![true, true, true, true, true, true, true, true, true, true],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 4,
      pixels: vec![
        true, true, false, false, false, true, true, false, false, false, true, true, false, true,
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      ...
      width: 4,
      pixels: vec![
        false, false, true, true, false, true, true, false, true, true, false, false, false, true,
        true, false, false, false, true, true,
      ],
    },
  );
  ...
  glyphs.insert(
    ...
    PixelFontGlyph {
      name: ".",
      width: 1,
      pixels: vec![false, false, false, false, true],
    },
  );
